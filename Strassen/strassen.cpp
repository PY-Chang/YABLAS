...
double *strassen(double *temp, const double *a, const double *b, const int n){
    ...
    if(n <= 4096)                    // 設定閥值，決定切到多小時換回最原始的演算法
    ...
    strassen(p1, add_matrix(b_temp, b21, b22,n2,n2), sub_matrix(a_temp, a12, a22,n2,n2), n2);

    //p2 = (a11+a22)*(b11+b22)
    strassen(p2, add_matrix(a_temp, a11, a22,n2,n2), add_matrix(b_temp, b11, b22,n2,n2), n2);
    
    //p3 = (b11+b12)*(a11-a21)
    strassen(p3, add_matrix(b_temp, b11, b12,n2,n2), sub_matrix(a_temp, a11, a21,n2,n2), n2);
    
    //p4 = (a11+a12)*b22
    strassen(p4, add_matrix(a_temp, a11, a12,n2,n2), b22, n2);
    
    //p5 = a11*(b12-b22)
    strassen(p5, a11, sub_matrix(b_temp, b12, b22,n2,n2), n2);
    
    //p6 = a22*(b21-b11)
    strassen(p6, a22, sub_matrix(b_temp, b21,b11,n2,n2), n2);
    
    //p7 = (a21+a22)*b11
    strassen(p7, add_matrix(a_temp,a21,a22,n2,n2), b11, n2);


    //m11 = (p1+p2)-(p4+p6) >> 用上面做出來的結果去算各個 m
    sub_matrix(m11, add_matrix(a_temp, p1, p2, n2,n2), sub_matrix(b_temp, p4, p6, n2,n2), n2, n2);
    //m12 =  p4+p5
    add_matrix(m12, p4, p5, n2, n2);
    //m21 = p6+p7
    add_matrix(m21, p6, p7, n2, n2);
    //m22 = (p2+p5)-(p3+p6)
    sub_matrix(m22, add_matrix(a_temp, p2, p5, n2, n2), add_matrix(b_temp, p3, p6, n2, n2), n2, n2);
